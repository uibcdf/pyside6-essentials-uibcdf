...
#     1. shiboken6-uibcdf
#     2. pyside6-essentials-uibcdf  <-- this repo (needs shiboken6 built first)
...
# (If shiboken6-uibcdf is not yet built into the local channel, conda build stops
#  here with a clear 'nothing provides shiboken6-uibcdf' error — build it first.)
